            ...
            html += `
                <div class="col">
                    <div class="card shadow-sm h-100" data-bs-toggle="modal" data-bs-target="#modalProducto" data-product-id="${producto.id}" style="cursor:pointer;">
                        <img src="${producto.image}" class="card-img-top" alt="${producto.name}" onerror="this.onerror=null; this.src='https://placehold.co/600x400/CCCCCC/333333?text=Imagen+No+Disponible.'">
