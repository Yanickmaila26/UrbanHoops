        ...
        <form action="{{ route('purchase-orders.store') }}" method="POST" id="order-form">
            ...
            <div class="bg-white dark:bg-zinc-800 shadow rounded-lg p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="date" name="ORC_Fecha_Emision" value="{{ date('Y-m-d') }}"
                            class="w-full rounded-md border-gray-300 dark:bg-zinc-900 dark:text-white" required>
                    </div>
                    <div>
                        <label class="block text-sm font-medium dark:text-gray-300">Fecha Entrega</label>
                        <input type="date" name="ORC_Fecha_Entrega"
                            class="w-full rounded-md border-gray-300 dark:bg-zinc-900 dark:text-white" required>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-zinc-800 shadow rounded-lg p-6">
                        ...
                        <tr>
                            ...
                            <td class="py-4">
                                <input type="number" step="0.01" name="ORC_Monto_Total" id="total-final" readonly
                                    class="w-full font-bold border-none bg-transparent dark:text-blue-400" value="0.00">
                            </td>
                            <td></td>
                        </tr>
                    </tfoot>
                ...
                <div class="mt-6 flex justify-end">
                    <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded-md hover:bg-blue-700">Guardar
                        Orden</button>
                </div>
            </div>
        </form>
