            ...
            <nav class="flex-1 overflow-y-auto p-4">
                ...
                <div class="mb-6">
                    ...
                    <ul class="space-y-1">
                        ...
                        <!-- Kardex -->
                        <li>
                            <a href="{{ route('kardex.index') }}" wire:navigate
                                class="group flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition-colors {{ request()->routeIs('kardex.*') ? 'active-nav-link' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-800' }}">
                                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
