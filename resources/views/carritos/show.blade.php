...
<div class="max-w-7xl mx-auto p-6">
    ...
    <div class="bg-white dark:bg-zinc-800 shadow rounded-lg p-6 mb-6">
        <h3 class="text-lg font-medium text-gray-900 dark:text-gray-200 mb-4 border-b pb-2 border-gray-200 dark:border-zinc-700">Información del Cliente</h3>
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-zinc-700">
                <thead class="bg-gray-50 dark:bg-zinc-700">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 text-right text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Precio Unit.</th>
                ...
                <tfoot class="bg-gray-50 dark:bg-zinc-700">
                    <tr>
                        <td colspan="4" class="px-6 py-4 whitespace-nowrap text-sm font-bold text-right text-gray-900 dark:text-white uppercase">Total</td>
