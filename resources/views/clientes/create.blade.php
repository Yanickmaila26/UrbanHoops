...
@section('content')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="CLI_Ced_Ruc" id="CLI_Ced_Ruc"
                                        value="{{ old('CLI_Ced_Ruc') }}" required maxlength="13"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-zinc-700 dark:border-zinc-600 dark:text-white sm:text-sm @error('CLI_Ced_Ruc') border-red-500 @enderror"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="CLI_Nombre" id="CLI_Nombre" value="{{ old('CLI_Nombre') }}"
                                        placeholder="Ej: Juan Pérez" onkeypress="return soloLetras(event)"
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div>
                                    <label for="CLI_Direccion"
                                        class="block text-sm font-medium text-white-700 dark:text-gray-300">
                                        Dirección *
                                    </label>
                                    <input type="text" name="CLI_Direccion" id="CLI_Direccion"
                                        value="{{ old('CLI_Direccion') }}" required maxlength="150"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="tel" name="CLI_Telefono" id="CLI_Telefono"
                                            value="{{ old('CLI_Telefono') }}" required maxlength="10"
                                    ...
                                    <div>
                                        ...
                                        <input type="email" name="CLI_Correo" id="CLI_Correo"
                                            value="{{ old('CLI_Correo') }}" required maxlength="60"
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const cedulaInput = document.getElementById('CLI_Ced_Ruc');
